        ...
        <>
                    ...
                    <div className='container '>
                        ...
                        <div className='row '>
                            <div className='col-md-6 text-white h5'>
                                ...
                                <h5 className='text-danger'><BsFillTelephoneForwardFill></BsFillTelephoneForwardFill> Have any quetions?</h5>
                                <br></br>
                                9137314545/88245450840 <br></br>
                                <br></br>
                                <h5 className=' text-danger'><AiOutlineMail></AiOutlineMail> Have any query?</h5>
                                <br></br>
                                Dhananjayavare786@gmail.com<br></br><br></br>

                                <h5 className='text-danger'><HiLocationMarker></HiLocationMarker> Reach out!</h5>
                                <br></br>
            ...
            <div className='container-fluid color-for-container2'>
                ...
                <div className='row'>
                    ...
                    <center>    <h5 className='text-white'> Copyright received<span className="text-danger"> by Dhananjayavare786@gmail.com </span></h5></center> 
                    </div>
                    <div className='col-md-6'>
                    <center>     <h5 className='text-white'>Design by <span className="text-danger"> Dhananjay </span></h5></center> 
                    </div>
